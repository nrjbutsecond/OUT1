...
function LoginForm() {
  ...
  const handleGoogleLogin = () => {
    toast.info("Google OAuth will be integrated later")
  }

  return (
    <div className="min-h-screen flex items-center justify-center tedx-gradient-form p-4">
      <Card className="w-full max-w-md light-theme bg-white/95 backdrop-blur-sm border-red-200 shadow-2xl">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl text-center text-gray-900">Sign In</CardTitle>
          <CardDescription className="text-center text-gray-600">
            Sign in to your TON Platform account
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="space-y-2">
              <Label htmlFor="email" className="text-gray-900 font-medium">Email</Label>
                <Input
                  id="email"
                  type="email"
                  placeholder="admin@ton-platform.vn"
                  value={email}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="bg-white border-gray-300 text-gray-900 placeholder-gray-500 pr-10 focus:border-red-500 focus:ring-red-500/20"
                  required
                />
                <Button
                  type="button"
